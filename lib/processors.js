...
Processor.create(
  ...
  (c,m,r) => {
    ...
    return c.set('masterVolumeMax', max)
  }
)
...
Processor.create(
  ...
  /^PSSWL (ON|OFF)$/,
  (c,m,r) => {
    return c.set('subLevelEnabled', m[1] == "ON")
  }
)
